...
# from dbgpt_app.expend.router.process_router import DeleteFilesRequest
...
#
# @router.get("/files")
# async def get_files(manager: PipelineManager = Depends(get_pipeline_manager)):
#     """获取文件列表"""
#     try:
...
# async def get_knowledge_mappings(manager: PipelineWebManager = Depends(get_pipeline_manager)):
#     """获取知识库映射配置"""
#     try:
